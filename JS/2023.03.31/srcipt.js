...
// Создать ToDo list на jQuery 

// Создать генератор блоков. Имеются 3 инпута. 1 инпут ширина блока 2 инпут высота блока. 3 инпут цвет блока. при нажатий на кнопку блок должен появляться с заданными параметрами